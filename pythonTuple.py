# Tuples are similar to lists, but Tuples are immutable in nature i.e. once created it cannot be modified. Just like a list, Tuples can also contain elements of various types.
